...
export interface AuANFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface AuANFT extends BaseContract {
  connect(runner?: ContractRunner | null): AuANFT;
  waitForDeployment(): Promise<this>;

  interface: AuANFTInterface;
